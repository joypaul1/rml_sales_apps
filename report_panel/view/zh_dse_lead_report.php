...
$selected_emp_id = isset($_POST['emp_id']) ? $_POST['emp_id'] : (isset($_SESSION['selected_emp_id']) ? $_SESSION['selected_emp_id'] : '');
$selected_mode = isset($_POST['lead_mode']) ? $_POST['lead_mode'] : (isset($_SESSION['selected_mode']) ? $_SESSION['selected_mode'] : '');
