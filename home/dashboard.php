...
<body>
								...
								<div class="card avtivity-card">
									<div class="card-body">
										...
										<div class="progress" style="height:5px;">
											<div class="progress-bar bg-success" style="width: 42%; height:5px;" aria-label="Progess-success"
												role="progressbar">
							...
							<div class="col-sm-6">
								<div class="card avtivity-card">
									<div class="card-body">
										...
										<div class="progress" style="height:5px;">
											<div class="progress-bar bg-secondary" style="width: 82%; height:5px;" aria-label="Progess-secondary"
												role="progressbar">
												<span class="sr-only">42% Complete</span>
											</div>
										</div>
							...
							<div class="col-sm-6">
								<div class="card avtivity-card">
									<div class="card-body">
										...
										<div class="progress" style="height:5px;">
											<div class="progress-bar bg-danger" style="width: 90%; height:5px;" aria-label="Progess-danger"
												role="progressbar">
												<span class="sr-only">42% Complete</span>
											</div>
										</div>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header d-sm-flex d-block pb-0 border-0">
										...
										<a href="https://gymove.dexignzone.com/codeigniter/demo/food_menu"
										...
										<div class="testimonial-one owl-carousel">
											<div class="items">
												<div class="card text-center">
													<div class="card-body">
														<img src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/testimonial/1.jpg"
															alt="">
														<h5 class="fs-16 font-w500 mb-1"><a
																href="https://gymove.dexignzone.com/codeigniter/demo/app_profile"
														...
														<div class="d-flex align-items-center justify-content-center">
															...
															<a href="https://gymove.dexignzone.com/codeigniter/demo/app_profile"
																class="btn-link fs-14">Send Request</a>
														</div>
													</div>
												</div>
											</div>
											<div class="items">
												<div class="card text-center">
													<div class="card-body">
														<img src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/testimonial/2.jpg"
															alt="">
														<h5 class="fs-16 font-w500 mb-1"><a
																href="https://gymove.dexignzone.com/codeigniter/demo/app_profile"
											...
											<div class="items">
												<div class="card text-center">
													<div class="card-body">
														<img src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/testimonial/3.jpg"
															alt="">
														<h5 class="fs-16 font-w500 mb-1"><a
																href="https://gymove.dexignzone.com/codeigniter/demo/app_profile"
											...
											<div class="items">
												<div class="card text-center">
													<div class="card-body">
														<img src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/testimonial/4.jpg"
															alt="">
														<h5 class="fs-16 font-w500 mb-1"><a
																href="https://gymove.dexignzone.com/codeigniter/demo/app_profile"
								...
								<div class="card featuredMenu">
									...
									<div class="card-body loadmore-content height700 dz-scroll pt-0" id="FeaturedMenusContent">
										<div class="media mb-4">
											<img src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/menus/1.png" width="85"
												alt="" class="rounded me-3">
											<div class="media-body">
												<h5><a href="https://gymove.dexignzone.com/codeigniter/demo/food_menu"
														class="text-black fs-16">Chinese Orange Fruit With Avocado Salad</a></h5>
										...
										<ul class="d-flex flex-wrap pb-2 border-bottom mb-3 justify-content-between">
											<li class="me-3 mb-2"><i class="las la-clock scale5 me-2"></i><span class="fs-14 text-black">4-6 mins
												</span></li>
											<li class="mb-2"><i class="fa-regular fa-star me-2 scale1 text-warning" aria-hidden="true"></i><span
													class="fs-14 text-black font-w500">176 Reviews</span></li>
										</ul>
										<div class="media mb-4">
											<img src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/menus/2.png" width="85"
												alt="" class="rounded me-3">
											<div class="media-body">
												<h5><a href="https://gymove.dexignzone.com/codeigniter/demo/food_menu" class="text-black fs-16">Fresh
														or Frozen (No Sugar Added) Fruits</a></h5>
										...
										<div class="media mb-4">
											<img src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/menus/3.png" width="85"
												alt="" class="rounded me-3">
											<div class="media-body">
												<h5><a href="https://gymove.dexignzone.com/codeigniter/demo/food_menu" class="text-black fs-16">Fresh
														or Frozen (No Sugar Added) Fruits</a></h5>
										...
										<div class="media mb-4">
											<img src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/menus/4.png" width="85"
												alt="" class="rounded me-3">
											<div class="media-body">
												<h5><a href="https://gymove.dexignzone.com/codeigniter/demo/food_menu"
														class="text-black fs-16">Original Boiled Egg with Himalaya Salt</a></h5>
									...
									<div class="card-footer style-1 text-center border-0 pt-0 pb-4">
										<a class="text-primary dz-load-more fa fa-chevron-down" aria-label="Featured-icon" id="FeaturedMenus"
											href="javascript:void(0);" rel="public/assets/ajax/featured-menu-list.html">
										</a>
									</div>
								</div>
							</div>
	...
	<script src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/vendor/global/global.min.js"></script>
	<script src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/vendor/bootstrap-select/js/bootstrap-select.min.js"></script>
	<script src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/vendor/chart-js/chart.bundle.min.js"></script>
	<script src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/vendor/owl-carousel/owl.carousel.js"></script>
	<script src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/vendor/peity/jquery.peity.min.js"></script>
	<script src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/vendor/apexchart/apexchart.js"></script>
	<script src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/js/dashboard/dashboard-1.js"></script>
	<script src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/js/custom.min.js"></script>
	<script src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/js/deznav-init.js"></script>
	<script>
