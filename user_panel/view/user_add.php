                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="sall_user_id" placeholder="000773" required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="sall_user_name" placeholder="Syad Maruf Ahmed" required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="emp_mobile" required="" placeholder="01993338317">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
