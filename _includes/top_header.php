                ...
                <ul class="navbar-nav header-right">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-2">
                                                <img alt="image" width="50" src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/avatar/1.jpg">
                                            </div>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                            <img src="https://gymove.dexignzone.com/codeigniter/demo/public/assets/images/profile/17.jpg" width="20" alt="">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="https://gymove.dexignzone.com/codeigniter/demo/app_profile" class="dropdown-item ai-icon">
                            ...
                            <a href="https://gymove.dexignzone.com/codeigniter/demo/email_inbox" class="dropdown-item ai-icon">
                            ...
                            <a href="https://gymove.dexignzone.com/codeigniter/demo/page_login" class="dropdown-item ai-icon">
